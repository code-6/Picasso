...
import {By, Navigation, WebDriver, WebElement, WebElementPromise} from 'lib/selenium-webdriver';
 ...
 */
for (let foo in require('lib/selenium-webdriver')) {
  exports[foo] = require('lib/selenium-webdriver')[foo];
}
