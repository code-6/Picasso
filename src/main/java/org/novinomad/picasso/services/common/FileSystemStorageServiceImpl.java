...
public class FileSystemStorageServiceImpl implements FileSystemStorageService {
    ...
    public void store(MultipartFile file, String pathToFolder) throws StorageException {
        ...
        try {
            ...
            throw new StorageException("unable to store file {} in folder {} because {}",
    ...
    public List<Path> loadAll(String pathToFolder) throws StorageException {
        try {
            ...
            throw new StorageException("unable to load files in folder {} because {}", pathToFolder, e.getMessage(), e);
        }
    }
    ...
    public Path load(String path) throws StorageException {
        try {
            ...
            throw new StorageException("unable to load file {} because {}", path, e.getMessage(), e);
        }
    }
    ...
    public Resource loadAsResource(String filename) throws StorageException {
        try {
            ...
            throw new StorageException("unable to read file {} because {} ", filename, e.getMessage(), e);
        }
    }
    ...
    public void delete(String path) throws StorageException {
        try {
            ...
            throw new StorageException("unable to delete {} because {}", path, e.getMessage(), e);
        }
    }
    ...
    public Path createFolder(String path) throws StorageException {
        try {
            ...
            throw new StorageException("unable to create folder {} because {}", path, e.getMessage(), e);
        }
    }
}
